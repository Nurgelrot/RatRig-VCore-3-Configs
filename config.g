...
M92 X80.00 Y80.00 Z800.00 E690								; set steps per mm
...
M566 X550.00 Y550.00 Z250.00 E300.00						; set maximum instantaneous speed changes (mm/min) aka Jerk
M203 X18000.00 Y18000.00 Z800.00 E7200.00					; set maximum speeds (mm/min)
M201 X10000.00 Y10000.00 Z350.00 E5000						; set accelerations (mm/s^2)
M204 P6000 T8000

; Axis Limits
M208 X0 Y0 Z0 S1											; set axis minima
M208 X510 Y498 Z460 S0										; set axis maxima
...
; Z-Probe
M558 P8 C"121.io0.in" H15 F400:120 T18000 A6				; set Z probe type to unmodulated and the dive height + speeds
...
M557 X30:470 Y30:470 P6										; define mesh grid
...
M308 S1 P"121.temp0" Y"thermistor" T100000 B4138 A"Rapido"	; configure sensor 1 as PT1000 on pin 121.temp0
